    ...
    <div>
      ...
      >
        ...
        <div className="flex relative w-full min-w-[320px]">
          ...
          >
            <ListboxOptions
              className="absolute -bottom-[calc(100%-36px)] left-0 xsmall:left-auto xsmall:right-0 max-h-[442px] overflow-y-scroll z-[900] bg-white dark:bg-ui-bg-base drop-shadow-md text-small-regular uppercase text-black dark:text-ui-fg-base no-scrollbar rounded-rounded w-full"
              static
            >
              {options.map((o) => (
                <ListboxOption
